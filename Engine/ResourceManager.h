...
public:
	...
	*/
	...
	int addRawGraphic(SDL_Texture * source, const char * strName);

	int getGraphicByPath(const char* strName);
	...
	*/
	Sint32 createGraphic(const char* name, Uint16 width, Uint16 height, Uint8 r = 255, Uint8 g = 255, Uint8 b= 255);
